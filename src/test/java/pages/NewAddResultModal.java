...
public class NewAddResultModal extends BasePage {
    ...
    public static final String DROP_DOWN_OPTION_XPATH="//*[contains(@class,'chzn-drop')]//*[contains(text(),'%s')]";
    ...
    public void addResultForm(String statusOption, String comment, String assignToOption, String version, String elapsed, String defects) {
        ...
        driver.findElement(By.xpath(String.format(DROP_DOWN_OPTION_XPATH, statusOption))).click();
        ...
        driver.findElement(By.xpath(String.format(DROP_DOWN_OPTION_XPATH, assignToOption))).click();
